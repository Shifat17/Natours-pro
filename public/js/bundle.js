...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2hpZmF0MTciLCJhIjoiY2t1OGtsaW8wMHIwbjJ3bnphbW5sdTBrcyJ9.RcdZP5Is3WFTg9gwjn-tRQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/shifat17/ckucb3nbx720919nsg7elgiqr',
    scrollZoom: false,
    center: [-118.331524, 34.054284],
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p> Day: ".concat(loc.day, "  ").concat(loc.description, " </p>")).addTo(map); // extends the bounds to fit the current location
...
var loginForm = document.querySelector('.form--control');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "42573" + '/');
